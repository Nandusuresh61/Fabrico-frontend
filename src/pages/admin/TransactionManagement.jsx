...
import { getAllTransactionsApi, getTransactionByIdApi } from '../../api/TransactionApi';
import {
    Table,
    TableBody,
    TableCell,
                        ...
                        <div className="space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <p>{formatCurrency(selectedTransaction.transaction.amount)}</p>
                                </div>
                                <div>
                            ...
                            {selectedTransaction.transaction.orderId && (
                                <div>
                                    ...
                                    <Button 
                                        variant="outline" 
                                        onClick={() => navigate(`/admin/orders/${selectedTransaction.transaction.orderId}`)}
                                    >
                                        View Order Details
                                    </Button>
                                </div>
